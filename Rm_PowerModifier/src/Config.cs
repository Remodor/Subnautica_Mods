...
public class Config : ConfigFile
{
    ...
    [Slider("Modifier: Fin Charge Rate", 0.0f, 2.0f, DefaultValue = 1f, Format = "{0:F2}", Step = 0.01f, Tooltip = "The swim-charge-fins power production multiplier. Directly adjust the charge rate of the charge fins."), OnChange("OnConfigChange")]
    public float FinChargeRateModifier = 1f;
    ...
    public static void OnConfigChange()
    {
        ...
        FinChargeRateModifier_ = Instance.FinChargeRateModifier;
    ...
    internal static float FinChargeRateModifier_;
